...
class Lista_materias extends CI_Controller
{
	...
	public function index()
	{
		...
		if ($this->session->id_tipo == 1) {
            ...
            $data['materias'] = $this->materia_model->lista_materias_todos();

			$this->load->view("templates/views_sysmater/admin_views/admin_navbar_view");
			$this->load->view("templates/views_sysmater/admin_views/lista_materia_view", $data);
