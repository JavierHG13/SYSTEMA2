			...
			<nav class="navbar navbar-default">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="<?= site_url('/sysmater/director/director')?>">
							Director
						</a>
					</div>
						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li>
										<a href="<?= site_url('/sysmater/director/alumnos') ?>">
											Alumnos
										</a>
									</li>
									<li>
										<a href="<?= site_url('/sysmater/director/director/lista_docente') ?>">
											Docentes
										</a>
									</li>
								</ul>
