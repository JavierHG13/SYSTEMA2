...
<head>
	...
	<!-- module activities -->
	<!-- <script src="<?= base_url() ?>assets/js/alumno/fn_actividades.js"></script> -->
		...
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				...
				<div class="modal-body">
					<fieldset>
						...
						<div class="form-group">
							...
							<input class="form-control" placeholder="Contrase&ntilde;a" name="old_password" id="old_password" type="password"  required maxlength="8">
						</div>
						<div class="form-group">
							<label class="control-label" for="password">Nueva Contrase&ntilde;a</label>
							<input class="form-control" placeholder="Contrase&ntilde;a" name="password" id="password" type="password" required maxlength="8">
						</div>
				...
				<div class="modal-footer">
					...
					<button class="btn btn-primary" type="submit" id="cmd_guardar">Aceptar</button>
				</div>
				<?= form_close(); ?>
			</div>
		</div>
			...
			<nav class="navbar navbar-default">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="<?= site_url('sysmater/alumno/alumno') ?>">
							Alumno
						</a>
					...
					<div class="collpse navbar-collapse" id="navbar-1" aria-expanded="false">
						<ul class="nav navbar-nav">
							<!-- Examen -->
							<li>
								<a href="<?= site_url('/sysmater/alumno/alumno/examenes') ?>">
									Exámenes
								</a>
							</li>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li>
										<a href="<?= site_url('/sysmater/alumno/alumno/resultados_examenes') ?>">
											Resultados Examen
										</a>
									</li>
									<li>
										<a href="<?= site_url('/sysmater/alumno/alumno/resultados_actividades') ?>">
