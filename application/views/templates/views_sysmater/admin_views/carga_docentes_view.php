...
<div id="box">
    <h2 class="text-center">Cargar de Docentes</h2>
    <div id="animationContainer"></div>
    <form id="uploadForm" action="<?= site_url('/sysmater/admin/admin/carga_docentes') ?>" method="POST" enctype="multipart/form-data">
        ...
        <button type="submit" name="submit" class="btn btn-primary"><span class="glyphicon glyphicon-ok"></span> Cargar docentes</button>
    </form>
</div>
<div id="overlay">
