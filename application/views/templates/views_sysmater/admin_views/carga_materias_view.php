...
<div id="box">
  <h2 class="text-center">Cargar Materias</h2>
  <div id="animationContainer"></div>

  <form id="uploadForm" action="<?= site_url('/sysmater/admin/admin/carga_materias') ?>" method="POST" enctype="multipart/form-data">
    ...
    <button type="submit" name="submit" class="btn btn-primary mt-3">
      <span class="glyphicon glyphicon-ok"></span> Cargar materias
    </button>
  </form>
</div>
