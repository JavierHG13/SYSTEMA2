...
<body id="body">
	...
	<div class="" style="padding:20px;" id="contenedor">
		<header id="header">
			<center>
 				<img id="img_uthh"  class="img-responsive" src="<?= base_url() ?>assets/img/logo_uthh_completo.png">
			</center>
		</header>
		<div>
			<nav class="navbar navbar-default">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="<?= site_url('/sysmater/admin/admin/activacion_sistema')?>">
							Admin
						</a>
					</div>
						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li>
										<a href="<?= site_url('/sysmater/admin/admin/nueva_materia') ?>">
											Nueva materia
										</a>
									</li>
									<li>
										<a href="<?= site_url('/sysmater/admin/admin/lista_materias') ?>">
											Lista Materias 
										</a>
									</li>
									<li>
										<a href="<?= site_url('/sysmater/admin/admin/carga_materias') ?>">
											Cargar Materias
										</a>
									</li>
								</ul>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li>
										<a href="<?= site_url('/sysmater/admin/admin/nuevo_docente') ?>">
											Nuevo docente 
										</a>
									</li>

									<li>
										<a href="<?= site_url('/sysmater/admin/admin/lista_docente') ?>">
											Lista Docentes
										</a>
									</li>

									<li>
										<a href="<?= site_url('/sysmater/admin/admin/carga_docentes') ?>">
											Cargar docentes 
										</a>
									</li>
								</ul>
							...
							<li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button">
									Alumno(a) <span class="caret"></span>
								</a>
								<ul class="dropdown-menu">
									<li>
										<a href="<?= site_url('/sysmater/admin/nuevo_alumno') ?>">
											Nuevo alumno
										</a>
									</li>
									<li>
										<a href="<?= site_url('/sysmater/admin/alumnos') ?>">
											Lista Alumnos
										</a>
									</li>
									</li>
									<li>
										<a href="<?= site_url('/sysmater/admin/admin/carga_alumnos') ?>">
											Cargar Alumnos 
										</a>
									</li>
								</ul>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li>
										<a href="<?= site_url('/sysmater/admin/admin/examenes_registrados') ?>">
											Exámenes registrados
										</a>
									</li>
									<li>
										<a href="<?= site_url('/sysmater/admin/admin/examenes_programados') ?>">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li>
										<a href="<?= site_url('/sysmater/admin/admin/reporte_examen') ?>">
											Resultados Examen
										</a>
									</li>
									<li>
										<a href="<?= site_url('/sysmater/admin/admin/reporte_examen_parciales') ?>">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li>
										<a href="<?= site_url('/Archivos_Plantillas/Plantilla_Alumnos_Carga.xlsx') ?>">
											Plantilla De Alummnos
										</a>
									</li>
									<li>
									...
									<li>
										<a href="<?= site_url('/Archivos_Plantillas/Plantilla_Materias_Carga_Sysmater.xlsx') ?>">
											Plantilla De Materias
										</a>
									</li>
									<li>
										<a href="<?= site_url('/Archivos_Plantillas/Plantilla_Docentes_Carga.xlsx') ?>">
