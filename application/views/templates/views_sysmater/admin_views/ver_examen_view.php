...
<head>
	...
	<script src="<?= base_url() ?>assets/js/admin/fn_examen_preview_sysmater.js"></script>
</head>
					 ...
					 <div class="panel-footer" id="Botones">
					 	<div class="row">
					 		<div class="col col-sm-6">
								...
								<a href="<?= site_url('/sysmater/admin/admin/examenes_registrados/') ?>" role="button" class="btn btn-success" id="finalizar">
