...
function upload_questions(id_test)
{
	...
	var url =  base_url+'/sysmater/admin/ver_examen/get_questions/' + id;
	$.ajax({
		type: 'GET',
		url: url,
		dataType:'json',
...
function _time_left(id_test)
{
	...
	var url =  base_url+'/sysmater/admin/ver_examen/get_time/' + matricula;
	$.ajax({
		type: 'GET',
		url: url,
		dataType:'json',
...
{
	var url =  base_url+'/sysmater/admin/ver_examen/check_responses/' +matricula+'/'+ id;
	$.ajax({
		type: 'GET',
		url: url,
		dataType:'json',
