...
function exportar(tipo){
	...
	if (examenes)
	{
		...
		if (confirm(string))
		{ 
			$("#reporte_examen #task").val(tipo);
			$("#reporte_examen #tbl").val($("div.tabla").html());
			$("#reporte_examen #name_file").val(carrera+"-"+examenes);
...
function get_resultados(){
	...
	carrera = $('#carrera').val();
	examen = $('#examenes').val();
	$.post( base_url+"/egel/admin/reporte_examen/get_resultados_examen/" + carrera + "/"+examen,
	{
		examen : examen
	},
	function(data)
